...
#VGG19
model("VGG19", epochs=5, batch_size=256, learning_rate=1e-3)
model("VGG19", epochs=5, batch_size=128, learning_rate=1e-3)
model("VGG19", epochs=5, batch_size=64, learning_rate=1e-3)
#resnet50
model("ResNet50", epochs=5, batch_size=256, learning_rate=1e-3)
model("ResNet50", epochs=5, batch_size=128, learning_rate=1e-3)
model("ResNet50", epochs=5, batch_size=64, learning_rate=1e-3)
#Xception
model("Xception", epochs=5, batch_size=64, learning_rate=1e-3)
model("Xception", epochs=5, batch_size=128, learning_rate=1e-3)
model("Xception", epochs=5, batch_size=256, learning_rate=1e-3)
